...
//using BBQN.IdentityManagement.API.Middleware;
...
builder.Services.AddSingleton<ILoginDBAdaptor, LoginDbAdaptor>();
  ...
  builder.Services.AddSwaggerGen(swagger =>
{
    ...
    swagger.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Description = "BBQN Idenetity Management and Token Generation"
    });
